...
// throws : 메서드 선언부에서 예외 발생 시 던질 수 있음을 명시함
// ( = 이 메서드 호출한 쪽에서 예외 처리해야 함을 알림)
// throw : 특정 조건에서 예외를 직접 발생시킨 ( = 예외 객체 만듬 )
...
//	withdraw 메서드 생성 (출금)
//	그 구현부에 if 조건 : 잔액이 부족하면 잔액 부족 관련 예외 생성해서 throw 키워드로 예외 생성
...
// 잔액 부족 관련 메서드
// 메서지 넘긴걸로 에러 문구 보여주는 사용자 정의 클래스
